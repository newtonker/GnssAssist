...
public class SignalScaleBar extends SurfaceView implements Callback
{
	...
	private SignalScaleBarCallbacks mSignalScaleBarCallbacks = new SignalScaleBarCallbacks()
	{
		...
		{
			mScaleLayoutWidth = orientationFragment.getmScaleLayoutWidth();
			mScaleLayoutHeight = orientationFragment.getmScaleLayoutHeight();
			mBorderTop = mMarginValue;
			mBorderBottom = mScaleLayoutHeight - mMarginValue;
			mBorderLeft = mMarginValue;
			mBorderRight = mScaleLayoutWidth - mMarginValue;
			//纵向上分成6格
