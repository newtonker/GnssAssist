...
public interface SignalCallbacks
{
	 ...
	 */
	void updateSignalViewSwitch(boolean isGnssEnabled);

	/**
	 * 更新GNSS定位状态信息
	 * @param isGnssEnabled
	 */
	void updateSignalViewFixStatus(boolean isGnssEnabled, String string);
	 ...
	 * @param isGnssEnabled 检测GNSS是否可用，true:可用, false:不可用
	 */
	void updateSignalViewSnrInfo(SatelliteAdapter satelliteAdapter, boolean isGnssEnabled);
}
