...
public class BdsBarChart extends SurfaceView implements Callback
{
    ...
    private BdsBarChartCallbacks mBdsBarChartCallbacks = new BdsBarChartCallbacks()
    {
        ...
        {
            int mSnrLayoutWidth = signalFragment.getmBdsSnrLayoutWidth();
            int mSnrLayoutHeight = signalFragment.getmBdsSnrLayoutHeight();
    ...
    public void drawBdsBarChart(SatelliteAdapter satelliteAdapter, Canvas canvas)
    {
        ...
        isUsedInFix = false;
        List<MySatellite> mGpsSatelliteList = satelliteAdapter.getmBdsSatelliteList();
        ...
        for (int i = 0; i < mGpsSatelliteSize; i++)
        {
            ...
            // 柱状图
            canvas.drawRect(mBorderLeft + mBarGap * i, mBorderBottom - mSnr * mSnrGap, mBorderLeft + mBarGap * (i + 1) - mBdsBarChartSpacing, mBorderBottom, mChartPaint);
            // 信噪比值
